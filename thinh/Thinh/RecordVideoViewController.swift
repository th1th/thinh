...
class RecordVideoViewController: UIViewController,AVCaptureFileOutputRecordingDelegate {
    ...
    override func viewDidLoad() {
        ...
        photoButton.layer.borderColor = UIColor( red: 170/255, green: 254/255, blue:235/255, alpha: 0.5).cgColor
    ...
    @IBAction private func toggleCaptureMode(_ captureModeControl: UISegmentedControl) {
        utilities.log("mode: \(captureModeControl.selectedSegmentIndex)")
        utilities.log("\(previewView.videoPreviewLayer.frame.width)x\(previewView.videoPreviewLayer.frame.height)")
    ...
    @IBAction private func capturePhoto(_ photoButton: UIButton) {
        ...
        sessionQueue.async {
            ...
            //turn off flash for font camera
    ...
    @IBAction private func toggleLivePhotoMode(_ livePhotoModeButton: UIButton) {
        livePhotoModeButton.titleLabel?.textColor = UIColor.black
        sessionQueue.async { [unowned self] in
